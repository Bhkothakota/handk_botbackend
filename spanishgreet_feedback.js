...
module.exports.createFeedbackCardSpanish = () => {
  return CardFactory.adaptiveCard({
    ...
    body: [
      {
        "type": "TextBlock",
        "text": "¡Saludos! Soy Lexi, la asistente de IA de Holland & Knight. Estoy aquí para brindar información sobre nuestros servicios y ayudar con cualquier pregunta legal. ¿Cómo puedo ayudarte hoy?",
        "wrap": true
      },
      {
        type: "Container",
