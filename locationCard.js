...
function createLocationsCard() {
    return CardFactory.adaptiveCard({
        ...
        "body": [
            {
                "type": "TextBlock",
                "text": "Holland & Knight LLP is headquartered in Tampa, Florida. Holland & Knight has more than 25 offices located across the United States, as well as international offices in key cities like London, Bogota, and Mexico City.",
                "wrap": true
            },
            {
                "type": "TextBlock",
                "text": "Citation - [[1]](https://www.hklaw.com/en/offices \"H&K Offices Page\")",
                "wrap": true,
                "isSubtle": true,
                "size": "Small"
            },
...
module.exports.createLocationsCard = createLocationsCard;