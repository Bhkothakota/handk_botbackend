...
module.exports.createAboutHKCard = () => {

    const aboutCard = CardFactory.adaptiveCard({
        "type": "AdaptiveCard",
        "version": "1.2",
        "body": [
            {
                "type": "TextBlock",
                "text": `Holland & Knight LLP is a multinational law firm with nearly 2000 attorneys and professional staff worldwide. Headquartered in Tampa, Florida, the firm has a number of different practices areas, including litigation, corporate law, real estate, construction law, and intellectual property. [[1]](https://www.hklaw.com)`,
                //"text" : response,
                "wrap": true
            },
            {
