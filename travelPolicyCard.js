...
module.exports.createTravelPolicyCard = () => {
    return CardFactory.adaptiveCard({
        ...
        "body": [
            {
                "type": "TextBlock",
                "text": "The travel policy payout limit per day varies based on the location and the employee's grade. Here are the details for domestic travel in US:",
                "wrap": true,
                "size": "default"
            },
            {
                "type": "TextBlock",
                "text": "Maximum per day rate for US including taxes:",
                "wrap": true,
                "size": "default",
                "weight": "Bolder"
              },
            
            {
                ...
                "facts": [
                  {
                    "title": "A-B grades:",
                    "value": "Tier 1 cities: USD 6000"
                  },
                  {
                    "title": "",
                    "value": "Other cities: USD 4500"
                  }
        ]},
        {
            "type": "TextBlock",
            "text": "For international travel, the per diem limits are defined for each country/location. Employees designated from A1 to B2 traveling on Business Visa will be paid per diem as per the Business Travel Letter or Letter of Assignment as per the Group Global Travel and Expense Policy. [[1]](https://www.hklaw.com/en/firm/legal/privacy)",
            "wrap": true,
            "size": "default",
          ...
          },
        {
            ...
            "type": "TextBlock",
            "text": "Finance_Travel_Policy_25.pdf",
            "wrap": true,
            "size": "default",
                ...
                "citation": [
                    {
                        ...
                        "appearance": {
                            ...
                            "keywords": ["Holland & Knight", "AI bot", "Law Firm"],
